...
const PhoneNumberFormatter: React.FC = () => {
  ...
  useEffect(() => {
    const initializeApp = async () => {
      try {
        ...
        if (!result.success) {
          setWarning(
            "ডাটাবেস কানেকশন ব্যর্থ হয়েছে। দয়া করে পরে আবার চেষ্টা করুন।"
          );
        }
      } catch (error) {
    ...
    initializeApp();
  }, []); // loginKey ডিপেন্ডেন্সি সরিয়ে দেওয়া হল
  ...
  const formatPhoneNumber = async (number: string) => {
    ...
    try {
      ...
      if (data && data.length > 0) {
        setWarning("এই নম্বরটি ইতিমধ্যে ডাটাবেসে বিদ্যমান!");
      } else {
        setWarning("");
      }
    } catch (err) {
      setWarning("ডাটাবেস চেক করতে সমস্যা হয়েছে।");
    }
  };
  ...
  const handleCopyAndSave = async () => {
    ...
    try {
      ...
      alert("সংরক্ষণ করতে সমস্যা হয়েছে। দয়া করে আবার চেষ্টা করুন।");
    }
  };
